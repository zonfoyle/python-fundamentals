...
def main():
    ...
    #Set item name,item_price, quantity_rate, and eligible_items
    item_name = 'banana'
    quantity = 5
    discount_rate = 0.1
    ...
    """Arithmetic operators"""
     #Calculate subtotal as item_price multipled (*) by quantity 
    subtotal = item_price * quantity  

    #print item_name, subtotal 
    print(f"item_price: {item_name}, subtotal: ${subtotal}")
    ...
    #(used to check if item is eligible for discount)
    ...
    """Logical operators"""
    #Check if free shipping should b appllied (quantity > 5 AND item_name = "banana")
    does_free_shipping_apply = quantity >= 5 and item_name == "banana"
    print(f"does_free_shipping_apply ? {does_free_shipping_apply}")
